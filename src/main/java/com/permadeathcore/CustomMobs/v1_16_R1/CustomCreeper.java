...
import net.minecraft.server.v1_16_R1.EntityDamageSourceIndirect;
...
import net.minecraft.server.v1_16_R1.PathfinderGoal.Type;
...
public class CustomCreeper extends EntityCreeper {
   ...
   public boolean damageEntity(DamageSource var1, float var2) {
      if (this.isInvulnerable(var1)) {
         ...
         if (!this.world.s_() && this.random.nextInt(10) != 0 && this.a) {
            this.a();
         }
   ...
   private boolean a(double var1, double var3, double var5) {
      ...
      return var9 ? this.a(var1, var3, var5, true) : false;
   }
}
