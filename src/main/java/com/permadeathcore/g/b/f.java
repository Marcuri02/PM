...
public class f implements com.permadeathcore.g.c {
   public Class c(String var1) {
      Class var2 = null;

      try {
         var2 = Class.forName("org.bukkit.craftbukkit.v1_16_R1.entity." + var1);
   ...
   public Class a() {
      ...
      try {
         var1 = Class.forName("net.minecraft.server.v1_16_R1.EntityTypes");
   ...
   public Class a(String var1) {
      try {
         return Class.forName("net.minecraft.server.v1_16_R1." + var1);
      } catch (ClassNotFoundException var3) {
         var3.printStackTrace();
         return null;
      }
   ...
   public void a(Player var1, String var2) {
      IChatMutableComponent var3 = ChatSerializer.a("{\"text\": \"" + var2 + "\"}");
      PacketPlayOutChat var4 = new PacketPlayOutChat(var3, ChatMessageType.GAME_INFO, UUID.randomUUID());
   ...
   public void a(Player var1, String var2, String var3, int var4, int var5, int var6) {
      IChatMutableComponent var7 = ChatSerializer.a("{\"text\": \"" + var2 + "\"}");
      IChatMutableComponent var8 = ChatSerializer.a("{\"text\": \"" + var3 + "\"}");
   ...
   public Entity a(String var1, EntityType var2, Location var3, SpawnReason var4) {
      ...
      net.minecraft.server.v1_16_R1.Entity var6 = null;
      ...
      try {
         ...
         if (!var1.toLowerCase().contains("bat") && !var1.toLowerCase().contains("cod") && !var1.toLowerCase().contains("salmon") && !var1.toLowerCase().contains("squid") && !var1.toLowerCase().contains("pufferfish") && !var1.toLowerCase().contains("tropicalfish")) {
            var6 = (net.minecraft.server.v1_16_R1.Entity)var7.getConstructor(this.a("EntityTypes"), this.a("World")).newInstance(this.b(var2), var5);
      ...
      try {
         ...
         if (!var4.toLowerCase().contains("villager") && !var4.toLowerCase().contains("wanderingtrader")) {
            if (!var4.toLowerCase().contains("bat") && !var4.toLowerCase().contains("cod") && !var4.toLowerCase().contains("salmon") && !var4.toLowerCase().contains("squid") && !var4.toLowerCase().contains("pufferfish") && !var4.toLowerCase().contains("tropicalfish")) {
               var6 = (net.minecraft.server.v1_16_R1.Entity)var14.getConstructor(Location.class, Main.p().f().a("EntityTypes")).newInstance(var2, Main.p().f().a(var1));
            } else if ((new Random()).nextInt(499) <= 10) {
               var6 = (net.minecraft.server.v1_16_R1.Entity)var14.getConstructor(Location.class, Main.p().f().a("EntityTypes")).newInstance(var2, Main.p().f().a(var1));
            }
         } else if (var4.toLowerCase().contains("villager")) {
            var6 = (net.minecraft.server.v1_16_R1.Entity)var14.getConstructor(Location.class, Main.p().f().a("EntityTypes"), Villager.class).newInstance(var2, Main.p().f().a(var1), null);
         } else {
            var6 = (net.minecraft.server.v1_16_R1.Entity)var14.getConstructor(Location.class, Main.p().f().a("EntityTypes"), WanderingTrader.class).newInstance(var2, Main.p().f().a(var1), null);
         }
   ...
   public Entity b(String var1, EntityType var2, Location var3, SpawnReason var4) {
      ...
      try {
         ...
         var6 = (net.minecraft.server.v1_16_R1.Entity)var7.getConstructor(Location.class).newInstance(var3);
      ...
      if (var6 == null) {
         ...
         var6.setPositionRotation(var3.getX(), var3.getY(), var3.getZ(), var3.getYaw(), var3.getPitch());
         if (var1.toLowerCase().contains("customcod")) {
            Main.p().n().a((Double)1500.0D, (Double)30.0D, (Entity)var6.getBukkitEntity());
         }

         if (var1.toLowerCase().contains("pigmanjockeys.specialpig")) {
            Main.p().n().a((Attribute)Attribute.GENERIC_ATTACK_DAMAGE, (Double)40.0D, (Entity)var6.getBukkitEntity());
         }
