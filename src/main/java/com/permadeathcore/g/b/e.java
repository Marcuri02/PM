...
import net.minecraft.server.v1_15_R1.BiomeMushrooms;
...
public class e implements com.permadeathcore.g.c {
   public Class c(String var1) {
      Class var2 = null;

      try {
         var2 = Class.forName("org.bukkit.craftbukkit.v1_15_R1.entity." + var1);
   ...
   public Class a() {
      ...
      try {
         var1 = Class.forName("net.minecraft.server.v1_15_R1.EntityTypes");
   ...
   public Class a(String var1) {
      try {
         return Class.forName("net.minecraft.server.v1_15_R1." + var1);
      } catch (ClassNotFoundException var3) {
         var3.printStackTrace();
         return null;
      }
   ...
   public Entity a(String var1, EntityType var2, Location var3, SpawnReason var4) {
      ...
      net.minecraft.server.v1_15_R1.Entity var6 = null;
      ...
      try {
         ...
         if (!var1.toLowerCase().contains("bat") && !var1.toLowerCase().contains("cod") && !var1.toLowerCase().contains("salmon") && !var1.toLowerCase().contains("squid") && !var1.toLowerCase().contains("pufferfish") && !var1.toLowerCase().contains("tropicalfish")) {
            var6 = (net.minecraft.server.v1_15_R1.Entity)var7.getConstructor(this.a("EntityTypes"), this.a("World")).newInstance(this.b(var2), var5);
      ...
      try {
         ...
         if (!var4.toLowerCase().contains("villager") && !var4.toLowerCase().contains("wanderingtrader")) {
            if (!var4.toLowerCase().contains("bat") && !var4.toLowerCase().contains("cod") && !var4.toLowerCase().contains("salmon") && !var4.toLowerCase().contains("squid") && !var4.toLowerCase().contains("pufferfish") && !var4.toLowerCase().contains("tropicalfish")) {
               var6 = (net.minecraft.server.v1_15_R1.Entity)var14.getConstructor(Location.class, Main.p().f().a("EntityTypes")).newInstance(var2, Main.p().f().a(var1));
            } else if ((new Random()).nextInt(499) <= 10) {
               var6 = (net.minecraft.server.v1_15_R1.Entity)var14.getConstructor(Location.class, Main.p().f().a("EntityTypes")).newInstance(var2, Main.p().f().a(var1));
            }
         } else if (var4.toLowerCase().contains("villager")) {
            var6 = (net.minecraft.server.v1_15_R1.Entity)var14.getConstructor(Location.class, Main.p().f().a("EntityTypes"), Villager.class).newInstance(var2, Main.p().f().a(var1), null);
         } else {
            var6 = (net.minecraft.server.v1_15_R1.Entity)var14.getConstructor(Location.class, Main.p().f().a("EntityTypes"), WanderingTrader.class).newInstance(var2, Main.p().f().a(var1), null);
         }
   ...
   public Entity b(String var1, EntityType var2, Location var3, SpawnReason var4) {
      ...
      try {
         ...
         Class var7 = Class.forName("com.permadeathcore.CustomMobs.v1_15_R1." + var1);
         var6 = (net.minecraft.server.v1_15_R1.Entity)var7.getConstructor(Location.class).newInstance(var3);
   ...
   public void b() {
      Class var1 = BiomeBase.class;

      try {
         BiomeMushrooms var2 = (BiomeMushrooms)BiomeMushrooms.class.newInstance();
         Field var3 = var1.getDeclaredField("v");
         var3.setAccessible(true);
         Map var4 = (Map)var3.get(var2);
         ((List)var4.get(EnumCreatureType.MONSTER)).add(new BiomeMeta(EntityTypes.SPIDER, 100, 4, 4));
         ((List)var4.get(EnumCreatureType.MONSTER)).add(new BiomeMeta(EntityTypes.ZOMBIE, 95, 4, 4));
         ((List)var4.get(EnumCreatureType.MONSTER)).add(new BiomeMeta(EntityTypes.ZOMBIE_VILLAGER, 5, 1, 1));
         ((List)var4.get(EnumCreatureType.MONSTER)).add(new BiomeMeta(EntityTypes.SKELETON, 100, 4, 4));
         ((List)var4.get(EnumCreatureType.MONSTER)).add(new BiomeMeta(EntityTypes.CREEPER, 100, 4, 4));
         ((List)var4.get(EnumCreatureType.MONSTER)).add(new BiomeMeta(EntityTypes.SLIME, 100, 4, 4));
         ((List)var4.get(EnumCreatureType.MONSTER)).add(new BiomeMeta(EntityTypes.ENDERMAN, 10, 1, 4));
         ((List)var4.get(EnumCreatureType.MONSTER)).add(new BiomeMeta(EntityTypes.WITCH, 5, 1, 1));
         var3.set(var2, var4);
