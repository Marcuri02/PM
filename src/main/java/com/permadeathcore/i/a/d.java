...
public class d implements a {
   ...
   public boolean b(Location var1) {
      ...
      if (!var5 && var1.getBlock().getState() instanceof CreatureSpawner) {
         CreatureSpawner var6 = (CreatureSpawner)var1.getBlock().getState();
         if (var6.getSpawnedType() == EntityType.ARMOR_STAND) {
            var5 = true;
         }
      }
